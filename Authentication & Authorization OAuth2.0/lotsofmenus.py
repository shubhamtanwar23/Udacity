...
# Create dummy user
User1 = User(name="Shubham Tanwar", email="shubham.tanwar23@gmail.com",
             picture='https://lh5.googleusercontent.com/-CAdN3brDlXg/AAAAAAAAAAI/AAAAAAAAAq0/cuIUfnGXU-g/photo.jpg')
session.add(User1)
session.commit()
